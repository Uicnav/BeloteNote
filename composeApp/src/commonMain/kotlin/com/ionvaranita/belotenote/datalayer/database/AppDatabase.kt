...
abstract class AppDatabase : RoomDatabase(), DB {
    ...
    abstract fun points2PDao(): varanita.informatics.shared.database.dao.players2.Points2PDao

    abstract fun scor2PDao(): varanita.informatics.shared.database.dao.players2.Scor2PDao

    //PLAYERS 3
    abstract fun game3PDao(): varanita.informatics.shared.database.dao.players3.Game3PDao

    abstract fun points3PDao(): varanita.informatics.shared.database.dao.players3.Points3PDao

    abstract fun scor3PDao(): varanita.informatics.shared.database.dao.players3.Scor3PDao

    //GROUPS 2
    abstract fun points2GroupsDao(): varanita.informatics.shared.database.dao.groups2.Points2GroupsDao

    abstract fun scor2GroupsDao(): Scor2GroupsDao

    abstract fun game2GroupsDao(): varanita.informatics.shared.database.dao.groups2.Game2GroupsDao

    //PLAYERS 4
    abstract fun game4PDao(): varanita.informatics.shared.database.dao.players4.Game4PDao

    abstract fun points4PDao(): Points4PDao

    abstract fun scor4PDao(): varanita.informatics.shared.database.dao.players4.Scor4PDao

    //GLOBAL
    abstract fun winnerPointsDao(): WinnerPointsDao

    abstract fun boltDao(): varanita.informatics.shared.database.dao.BoltDao

    abstract fun boltManagerDao(): varanita.informatics.shared.database.dao.BoltManagerDao

    abstract fun extendedGameDao(): varanita.informatics.shared.database.dao.ExtendedGameDao
