...
data class Game3PEntity(@PrimaryKey(
    ...
    fun toUiModel(): Game3PUi {
        return Game3PUi(idGame = this.idGame, dateGame = dateGame.getFormattedDate(), statusGame = this.statusGame, winningPoints = this.winningPoints, name1 = this.name1, name2 = this.name2, name3 = this.name3, scoreName1 = this.scoreName1, scoreName2 = this.scoreName2, scoreName3 = this.scoreName3)
    }
}
