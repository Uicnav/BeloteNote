...
interface Game3PDao {
    ...
    @Query("update Game3PEntity set statusGame = :statusGame, scoreName1 = :scoreName1, dateGame =:dateGame  where idGame = :idGame")
    ...
    @Query("update Game3PEntity set statusGame = :statusGame, scoreName2 = :scoreName2, dateGame= :dateGame  where idGame = :idGame")
    ...
    @Query("update Game3PEntity set statusGame = :statusGame, scoreName3 = :scoreName3, dateGame = :dateGame  where idGame = :idGame")
