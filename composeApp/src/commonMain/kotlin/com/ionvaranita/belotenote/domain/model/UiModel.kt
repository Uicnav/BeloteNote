...
data class Game2PUi(val idGame: Short, val statusGame: Byte, val winningPoints: Short, val name1: String, val name2: String) {
...
data class Game3PUi(val idGame: Short, val statusGame: Byte, val winnerPoints: Short, val name1: String, val name2: String, val name3: String) {
...
data class Game4PUi(val idGame: Short, val statusGame: Byte, val winnerPoints: Short, val name1: String, val name2: String, val name3: String, val name4: String) {
...
data class Game2GroupsUi(val idGame: Short, val statusGame:Byte, val winnerPoints: Short, val name1: String, val name2: String) {
